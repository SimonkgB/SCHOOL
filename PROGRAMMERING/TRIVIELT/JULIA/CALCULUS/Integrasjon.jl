...
# ╔═╡ 549cf110-e3e9-11ed-0b1b-554b3b6b4a37
using QuadGK, ForwardDiff, Plots, PlutoUI

# ╔═╡ 91b7a1d9-4c1d-4c9a-8f09-18d0a08df77d
md"## Define Functions"

# ╔═╡ be241e21-716b-465c-a2ae-1c71ecc9ee7d
f(x) = sqrt(x)

# ╔═╡ 883354ba-0a5f-432f-9b65-f56b8f764712
md"""
a: $(@bind a Slider(0.0:0.01:4.0, 0.0, true)) |
b: $(@bind b Slider(0.0:0.01:4.0, 4.0, true))
"""

# ╔═╡ c624b23c-98bc-4a4c-be6d-8240a5677fb7
md"$[a, b]"

# ╔═╡ aa8f15b0-88ab-48a8-ba1d-d412825022fc
xs = a < b ? (a:0.01:b) : (b:0.01:a)

# ╔═╡ 8625c092-cf74-4855-92be-0f21e997d0de
ya = round(f(a), digits=2)

# ╔═╡ 04729ae8-284d-4820-be11-f6103c8e4445
yb = round(f(b), digits=2)

# ╔═╡ a3b43c16-6d02-4367-bf91-cbb1b93c756a
area, area_error = quadgk(f,a,b)

# ╔═╡ 37c2b8bc-83a5-4d55-b282-6e364929f806
A = round(area, digits = 2)

# ╔═╡ f4ac43ea-f5fc-4907-b686-2b9ea7e3c713
begin
	# plot shaded area
	p2d = plot(xs, f.(xs),
		fill = true,
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "ed8a081a0fb5f3e1a6dd26ec713a942a4d3e6998"
