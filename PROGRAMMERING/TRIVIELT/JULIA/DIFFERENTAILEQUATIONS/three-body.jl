...
# ╔═╡ 98319e70-cb5d-4ed1-85f0-1542832e7bc8
...
begin
	...
	md"""
	Velocities ||
	vx1: $(@bind vx1_0 Scrubbable(-2.0:0.01:2.0, default = -0.148 * cosd(60),
		format = ".4f")) |
	vy1: $(@bind vy1_0 Scrubbable(-2.0:0.01:2.0, default =  0.148 * sind(60),
		format = ".4f")) |
	vx2: $(@bind vx2_0 Scrubbable(-2.0:0.01:2.0, default = -0.148 * cosd(60),
		format = ".4f")) |
	vy2: $(@bind vy2_0 Scrubbable(-2.0:0.01:2.0, default = -0.148 * sind(60),
		format = ".4f")) |
	vx3: $(@bind vx3_0 Scrubbable(-2.0:0.01:2.0, default =  0.148,
		format = ".4f")) |
	vy3: $(@bind vy3_0 Scrubbable(-2.0:0.01:2.0, default =  0.0,
		format = ".4f")) |
	"""
end
...
# ╔═╡ 93a1f5ad-812d-470f-b967-a892a4e4d87a
