...
# ╔═╡ 8a790fd0-f154-11ed-31ca-c99545fdadf3
using DifferentialEquations, Plots,ImageMagick, PlutoUI;plotly()

# ╔═╡ f68936a3-048f-4cd6-b2dd-4ad0d3c9fbd8
md"# Double Pendulum"

# ╔═╡ 1bd6f91a-aaef-4a1d-92ec-23627b75560b
md"$f(du, u, p, t) =
\begin{cases}
du[1] = {\theta_1}' = \omega_1 \\
du[2] = {\theta_2}' = \omega_2 \\
...
# ╔═╡ 2a8e7430-aa16-4ee9-9de1-2663ec069a44
...
# ╔═╡ 3a584cce-5fde-48a6-a0a4-6a040aad71db
@bind reset Button("Reset")

# ╔═╡ eed8091b-1338-4ee5-922c-b134ec634f8f
begin
	reset
	md"Time (s): $(@bind t_end Slider(0.0:0.00001:35.0, 35.0, true))"
end

# ╔═╡ fb1eed3e-2938-4fbe-a08d-6ac82249ab36
t_span=(0.0, t_end)

# ╔═╡ d45fdcf2-f5a1-48eb-bd60-42b6ac0987e3
begin
	reset
	md"""
	Initial Conditions ||
	theta1 (deg): $(@bind theta1d Scrubbable(0.0:0.1:180.0, default = 90.0)) |
	theta2 (deg): $(@bind theta2d Scrubbable(0.0:0.1:180.0, default = 90.0))
	"""
end

# ╔═╡ 9fb34c9c-08b2-473d-927c-a1ecb3a45680
theta1 = deg2rad(theta1d)

# ╔═╡ 6afdcb1e-cb50-4012-a855-8fc7b316cc2b
theta2 = deg2rad(theta2d)

# ╔═╡ a51f7979-c84c-4ca0-b417-7399d893510d
u_0 = [theta1, theta2, 0, 0]

# ╔═╡ fb6dc6b1-07d9-4543-b443-b8d710c5d172
begin
	reset
	md"""
	Parameters ||
...
# ╔═╡ ca5691a6-f1c1-416b-b4fb-5291de5c473e
p = [m1, m2, L1, L2, g]

# ╔═╡ 919bd09e-d155-4984-a03f-130368f114fc
prob = ODEProblem(double_pendulum, u_0, t_span, p)

# ╔═╡ 0c9f5337-21bd-40b9-85cd-b048a748898d
sol = solve(prob)

# ╔═╡ 5575541c-d00c-4e9f-987d-ce6092688db6
plot(sol,
	linewidth = 1.5
)

# ╔═╡ b14f6cc6-dc36-48a5-9cab-836b355bd173
...
# ╔═╡ 01e8d345-dbcc-4ef0-8fc7-88e275a3b7ea
pendulum1, pendulum2 = polar2cart(sol)

# ╔═╡ c097e67d-236a-41ce-babf-c4ae2387cacf
x1 = pendulum1[1][end]

# ╔═╡ 442abb61-3461-4d86-93bb-df5411978b88
y1 = pendulum1[2][end]

# ╔═╡ 4e82cbae-00ed-45c1-a49f-e9f3d8f91507
x2 = pendulum2[1][end]

# ╔═╡ fbeeda65-298e-4fe1-a621-21232cdd4041
y2 = pendulum2[2][end]

# ╔═╡ 45aa7502-0cda-4fcc-9b68-b720e6e44834
...
# ╔═╡ 07a72f05-7303-49d3-b5ac-4b233dbe6067
...
# ╔═╡ a57092a8-042b-47dd-9dfc-935ca1d09fbb
begin
	plot!(phase_x2y2,
		([0, x1, x2], [0, y1, y2]),
		color = :black,
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "73ce0d1bdbfc2d5151b4e4c05b862c17f2774de8"
