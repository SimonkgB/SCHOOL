...
# ╔═╡ c5b7b473-3b12-4f34-b653-6186f9e006ea
using DifferentialEquations, Plots, PlutoUI;plotly

# ╔═╡ a39f29b6-46f7-4431-92cf-09b7bd2a8d29
md"# Simple harmonic motion"

# ╔═╡ bf8f80eb-fcec-4fbe-bde2-4f9783fbaa87
md"# Describing problem"

# ╔═╡ 1d0c706a-a2a2-491d-8799-8a4023ddd776
md"$\frac{d^2x}{dt^2} = f(du, u, p, t)$"

# ╔═╡ 5c66cc25-64cf-4419-bbff-a73264db975e
md"$f(du, u, p, t) = - \frac{p[1]}{p[2]}u$"

# ╔═╡ b5657941-f6ab-4093-a154-a9e6bdfc2dc8
...
# ╔═╡ 0602d37a-09db-41f4-b910-b51585ec9b01
dx_0 = 0.0

# ╔═╡ c6f9681b-4fa4-4921-b5b4-7e31c811c4b0


# ╔═╡ eabe23d3-f80a-4227-9706-baccd6ad68c3
t_0 = 0.0

# ╔═╡ 4c84534b-f301-4c8a-9310-ed891d09ae95
md"## Define the second order ode"

# ╔═╡ fea7fdfa-47ea-44c4-93ee-49c26508467f
@bind reset Button("Reset sliders")

# ╔═╡ 9e699b00-a485-496c-af93-7b61ef2faf62
begin
	reset
	md"""||
	Initial position: $(@bind x_0 Slider(-0.25:0.01:0.25, 0.25, true)) | 
	time: $(@bind t Slider(0.0:0.01:20.0,20.0,true)) ||
	"""
end

# ╔═╡ f694cce7-43be-4cd5-90ca-f927cbec9577
t_span = (t_0,t)

# ╔═╡ 28202101-be9f-43d5-9288-3fa8cb67daf5
begin
	reset
	md"""||
	mass: $(@bind m Slider(0.5:0.01:2.0, 1.0, true)) | 
	 fjær konstant: $(@bind k Slider(0.5:0.01:2.0, 1.0, true)) ||
	"""
end

# ╔═╡ 327b3791-b688-46d5-9513-cc7e475c9ed5
p = [k,m]

# ╔═╡ a2fafd59-8920-4298-89fb-b6e24160f806
prob = SecondOrderODEProblem(harmonic, dx_0, x_0, t_span, p)

# ╔═╡ 9f2e4459-07be-496a-b33d-345d5e9062a1
sol = solve(prob)

# ╔═╡ 2198bedf-6bf0-42ea-ada8-9c580a0453d6
position = sol(t)[2]

# ╔═╡ 4b6d66ce-36d1-4777-9e2a-810a19d38164
velocity = sol(t)[1]

# ╔═╡ 7c52f010-0abd-4323-83be-7d65167793f3
...
# ╔═╡ 170629ec-1004-4ba7-a6bd-dffddc220757
acceleration = -k / m * position

# ╔═╡ 02fa35ed-18b0-4842-a7d4-1d71b95736e5
scatter!(phase, (position, velocity), color = :red, markersize = 5)

# ╔═╡ bb31a891-6ea0-4b14-8017-57eb074f4d48
plot(sol,
	legend = (0.8, 0.09),
	linewidth = 2,
...
# ╔═╡ 3d8eb971-6d6c-4c02-b11f-ac767d01b026
md"# calculating T(period)"

# ╔═╡ 4068c120-a4f5-4603-afca-14bce5ff36f0
function period(k,m)
	return 2*π*sqrt(m/k)
end

# ╔═╡ bcef9b01-a0e5-4aa6-96c3-716a5f16c79d
println(period(k,m))
