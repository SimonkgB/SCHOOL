...
# ╔═╡ fe1a5730-f05c-11ed-307c-0dd9b616a7c2
using DifferentialEquations, Plots, PlutoUI; plotly

# ╔═╡ 670b4153-7d87-4fa8-8560-d19e9d07a4ca
md"# Describe problem"

# ╔═╡ afa97987-21d4-478e-a3a8-748fa84adabe
md"$u = position$"

# ╔═╡ 32bfc20c-1dd4-4e10-821a-327cc8f38a3d
md"$\frac{du}{dt} = velocity$"

# ╔═╡ aa6959e3-77b8-49b2-9b1e-b5a356be7f52
md"# in julia"

# ╔═╡ ff1901bf-5413-45be-a489-0b17719be229
md"$\frac{d^2u}{dt^2} = f(du, u, p, t)$"

# ╔═╡ 1b6d420c-1cd1-4544-8a3b-13fa0463fcbe
const g_EARTH = -9.8067

# ╔═╡ ecdcb838-c3e1-4e82-8109-7c8e0c52cbe5
const g_MOON = -1.625

# ╔═╡ 8fce64cc-a557-4dc4-824e-ac556c229ff6
const g_MARS = -3.728

# ╔═╡ 7db1f5db-0933-41f3-a828-6c39ecf73621
@bind select_g Select(["Earth","Moon","Mars"])

# ╔═╡ cb568ba1-cc07-42a4-beb3-eafdd79d4af5
if select_g == "Moon"
	g = g_MOON
...
# ╔═╡ 6ab71b23-b1c2-409e-b06d-d7bebf0314ad
f(du, u, p, t) = [0, g]

# ╔═╡ c89a16cf-b261-485a-a3a2-b42af79077e3
u_xbegin, u_ybegin = 0.0,0.0 

# ╔═╡ f1fdc0a2-2fbe-475e-a5b2-1f4aa6deff6a
u_begin = [u_xbegin, u_ybegin]

# ╔═╡ e147266c-ed87-40e7-bb72-8a44c209cdb1
t_begin  = 0.0

# ╔═╡ 59bb5d1e-09bb-4f1f-a9ae-e71d67da8a1e
function f(sol)
	for i in 1.0:0.0001:5.0
		if sol(i)[4]<=0.0001
			return println(i)
			break
		else
...
# ╔═╡ 3519eb6b-894a-4d9a-bf03-8aaf4780870d
md"Initial Velocity: $(@bind v_begin Slider(1.0:30.0, 1.0, true))"

# ╔═╡ 4c2063e6-18a7-4550-9ac8-5c8e8b9aabf9
md"Angle in degrees: $(@bind θ Slider(0.0:90.0, 45.0,true))"

# ╔═╡ b8a8b92f-c261-47f8-9e24-26802b476ce2
v_xbegin,v_ybegin = v_begin*cosd(θ), v_begin*sind(θ)

# ╔═╡ 74b64f72-342b-4e74-8127-19b57f6f2167
du_begin = [v_xbegin, v_ybegin]

# ╔═╡ c075092f-6398-4337-a526-fe2abfe17c0e
md"Seconds: $(@bind t_end Slider(0.0:0.1:20.0, 20.0, true))"

# ╔═╡ 519c570a-5cb5-4bcb-a241-c3e18f2eefed
t_span = (t_begin, t_end)

# ╔═╡ ccf97320-ad12-4b9f-94a2-d706b8277949
prob = SecondOrderODEProblem(f, du_begin, u_begin, t_span)

# ╔═╡ 9d4a3fc8-a370-4387-90e4-88d8b642e200
sol = solve(prob)

# ╔═╡ 94114209-dbe6-45b8-80df-d50a56e249fa
y = f(sol)

# ╔═╡ b329ef63-4691-4d02-aba8-5f62c09d3ddb
print(y)

# ╔═╡ 25b53fd4-014a-4d90-8faf-4185090c59ca
sol(4)[3]

# ╔═╡ cfecd610-ccbc-4744-b1bf-2f6ea2a6542a
plot(sol,
	legend = true
)
