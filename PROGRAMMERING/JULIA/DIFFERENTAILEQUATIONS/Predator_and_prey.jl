...
# ╔═╡ e7352af0-f137-11ed-235f-8520dc630d64
using DifferentialEquations, Plots, PlutoUI

# ╔═╡ bacda5cb-9499-4b68-8d67-9184de4dc42f
md"# Define Problem"

# ╔═╡ 84301e72-cde2-4c35-abb1-c48bf140ecc5
md"#### koblet system:"

# ╔═╡ 9dd66396-5197-4d68-a1e9-83b68ba8fa7b
md"$\begin{align}
\frac{dx}{dt} &= \alpha x - \beta xy \\
\frac{dy}{dt} &= \delta xy - \gamma y
\end{align}$"

# ╔═╡ 1ba3c457-342a-467d-a384-e1abed86ea58
md"$f(du, u, p, t) =
\begin{cases}
...
# ╔═╡ e4d67112-6b47-49c1-b354-38e9df330ed5
...
# ╔═╡ 146c7487-4bc7-4fac-9d72-6180ec1747ab
md"### Variables"

# ╔═╡ f2de0601-947b-4e45-a1b7-d59df3bbb0b2
md"### parameters"

# ╔═╡ ada67948-5455-4ee0-95f5-fc6491ca03f8
t_begin = 0.0

# ╔═╡ 24e597bc-8f45-4db0-b6ab-e8b3ca77b590
md"# Define first order ODEs"

# ╔═╡ db3cd6ab-bd95-46ff-b504-8c9651480ce6
@bind reset Button("Reset")

# ╔═╡ 03505557-c58a-4291-94b0-1aca22e65564
begin
	reset
	md"""
...
# ╔═╡ 45365b8d-f7d3-478f-a03a-ffcd31ac9924
u_begin = [x_begin, y_begin]

# ╔═╡ 48714493-e1a8-4f32-b650-7a84c0f5ce29
begin
	reset
	md"""
	Baboon Growth:
		$(@bind alpha Scrubbable(0.1:0.01:2.0, default = 1.1, format = ".2f")) |
	Baboon Decline:
		$(@bind beta Scrubbable(0.1:0.01:1.0, default = 0.4, format = ".2f")) ||
	Cheetah Growth:
		$(@bind delta Scrubbable(0.1:0.01:1.0, default = 0.1, format = ".2f")) |
	Cheetah Decline:
		$(@bind gamma Scrubbable(0.1:0.01:1.0, default = 0.4, format = ".2f"))
	"""
end

# ╔═╡ d5d3109b-1974-4ad9-a7ee-0874afab7e0f
p = [alpha, beta, gamma, delta]

# ╔═╡ 871350ab-3e66-405c-8712-ec2ef4ef0830
begin
	reset
	md"Years: $(@bind t_end Slider(0.0:0.1:50.0, 20.0, true))"
end

# ╔═╡ a556a88d-29bd-451c-95b1-999cd7f860fe
tspan = (t_begin, t_end)

# ╔═╡ 7986c175-b6b0-4f85-8536-8a9516e553fb
prob = ODEProblem(lotka_volterra, u_begin, tspan, p)

# ╔═╡ 56166ed7-fdef-404e-a191-40cbe0cdcb64
sol = solve(prob)

# ╔═╡ 6d77c0b4-b3c0-4055-afcc-7d8d6bdd3c8d
baboon = sol(t_end)[1]

# ╔═╡ 2c6fbbb8-b9a9-42fc-88d7-2925cd9ed053
cheetah = sol(t_end)[2]

# ╔═╡ b465f9e2-dc31-4a8e-b51b-fc9b37f2d221
...
# ╔═╡ 81cdaf9b-91b8-4a0c-acdc-1ddbdfd144a2
scatter!(phase, (baboon, cheetah), color = :red, markersize = 5)

# ╔═╡ 9332d4af-c89c-45fa-8da1-87f00e0f72e5
plot(sol)
