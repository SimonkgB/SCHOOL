...
# ╔═╡ adcb6c90-f149-11ed-007f-a5ef232a3d49
using DifferentialEquations, Plots,PlutoUI; plotly()

# ╔═╡ 84b4d0f2-aed8-410b-970a-9094f0d2523f
md"## Define Problem"

# ╔═╡ ddb68b2c-abac-429e-87b4-081469f4b628
md"$\begin{align}
...
# ╔═╡ 8c4c0576-6ead-4a93-8156-1a08845bff03
md"$f(du, u, p, t) =
\begin{cases}
du[1] = p[1] (u[2] - u[1]) \\
...
# ╔═╡ 94a3eedb-09e6-4f83-bef0-93e9febab84d
md"## Define Julia Function"

# ╔═╡ 3c6cea35-974f-4641-9167-7e9d37318d59
...
# ╔═╡ 847062ca-2ce9-4590-939b-82856935b973
t_begin = 0.0

# ╔═╡ c575eabe-dc68-47be-b0ff-9721168e3750
t_end = 100.0

# ╔═╡ b8c70939-aa73-45a9-ac70-0882722717da
tspan = (t_begin, t_end)

# ╔═╡ 76e9e81a-b329-44ec-8aae-6cc3f8305bc3
@bind reset Button("Reset")

# ╔═╡ f161c435-7bab-4e91-bf02-40157b9145dd
begin
	reset
	md"""
	Initial ||
...
# ╔═╡ ae2dde7a-f8bf-441a-ac6e-e07af2a5a756
u_begin = [x_begin, y_begin, z_begin]

# ╔═╡ b8adc214-ee1f-4406-9a7e-035489ed2a9c
begin
	reset
	md"""
	Parameters ||
...
# ╔═╡ a75fdd97-c541-409a-bf65-a75eb6104054
p = [sigma, rho, beta]

# ╔═╡ 1295f39b-1636-462a-9d7e-12443be19ca5
prob = ODEProblem(lorenz, u_begin, tspan, p)

# ╔═╡ af19dff4-dbeb-41d5-b124-c20ae9ba59b5
sol = solve(prob, reltol = 1e-8, abstol = 1e-8)

# ╔═╡ 1edf5ece-47b0-49df-9df6-882bb5a1fec8
sol.t

# ╔═╡ 0e7ac493-12c7-4b5a-bbc3-88ae40510fd1
n = length(sol.t)

# ╔═╡ cf5c6ab9-93c1-4a73-ab67-b6793e11d44b
begin
	reset
	md"Index: $(@bind idx Slider(1:n, n, true))"
end

# ╔═╡ 8a448267-ef9a-491a-8756-2e2fb7315fbd
t = @view sol.t[1:idx]

# ╔═╡ 57f80d00-181d-48de-9908-36e89679a773
rime = t[idx]

# ╔═╡ 425f6b69-0796-4592-94b4-1b3dc6b1c227
md"# U"

# ╔═╡ 4ea3a3eb-cc2f-47ed-9ed9-1d1e6fc604a8
sol.u

# ╔═╡ 5e91b240-a0d9-419f-bfed-53b466848ef9
u = @view sol.u[1:idx]

# ╔═╡ a0bae183-13a5-485e-8a2c-42dd8d284c0f
sol_u_matrix = reduce(hcat, u)'

# ╔═╡ 143c91e4-9d2a-4a2e-8a95-443aea4fc118
x = sol_u_matrix[:, 1]

# ╔═╡ 8b5cacfa-3024-4dbd-a3a4-40237ee4b120
y = sol_u_matrix[:, 2]

# ╔═╡ 9819d783-a269-48da-97bb-18c7eed7b41c
z = sol_u_matrix[:, 3]

# ╔═╡ 1e181f8e-027a-4d06-9549-635706ed12e5
convection = x[idx]

# ╔═╡ d5d8b99e-a3db-45db-a13c-778feb4724e5
horizontal = y[idx]

# ╔═╡ 6fac2b86-eff4-446f-b1ed-80f3a10ab09b
vertical = z[idx]

# ╔═╡ 812fcb72-059b-4723-ad2b-a351c2fe3fba
md"## Plotting"

# ╔═╡ 42780344-b5d2-46cd-83ae-a90b0b794915
p_x_t = plot(t, x,
	legend = false,
...
# ╔═╡ 839fcb9a-d895-4df5-a528-c368546bb6d6
p_y_t = plot(t, y,
	legend = false,
...
# ╔═╡ 95efea93-72b6-43e6-983d-1cd813482fbf
phase_xy = plot(x, y,
	legend = false,
...
# ╔═╡ 7a126761-ddab-4e9c-9829-c97771ed98ce
p_z_t = plot(t, z,
	legend = false,
...
# ╔═╡ ef6c80e9-1e45-46bc-878b-99342a079f3a
phase_xz = plot(x, z,
	legend = false,
...
# ╔═╡ 4d2f405b-fee7-41e8-a332-d9571211d65c
phase_yz = plot(y, z,
	legend = false,
...
# ╔═╡ ec5d8cda-95ff-4b36-9940-2ef2e70bbd3e
...
# ╔═╡ ffdabda8-14b7-4d37-a696-68e32621ae67
scatter!(phase_xyz,
...
# ╔═╡ d4a99589-d39a-403e-848b-105acbd2fec4
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "f7d635425dc683eb24ac1426164e104527644d93"
