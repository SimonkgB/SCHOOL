...
# ╔═╡ fe809c35-603e-4d4b-989d-8c94ae95dfe8
using DifferentialEquations, Plots, PlutoUI;plotly

# ╔═╡ 27309632-f057-11ed-3d95-83b4af4c5dca
md"# Continuous Compund Interest"

# ╔═╡ d3837f70-91be-41ef-819c-91fd17c6a74a
md"## Describe Problem"

# ╔═╡ 73611d15-1df2-4c58-a36e-f77514ad223d
md"$\frac{du}{dt} = pu$"

# ╔═╡ 3b815ed9-d8b2-4b4f-8daa-2f25107c3ded
md"### How DE understand the problem"

# ╔═╡ 9548481d-3b59-423d-aac2-b5a65cfbece5
md"#### $f(u, p, t) = pu$"

# ╔═╡ 7f7061ed-02ad-45ae-850b-96a26dec8853
f(u, p, t) = p*u

# ╔═╡ a0c409e4-12af-4654-876a-c112759f6d0c
md"# Assign variables"

# ╔═╡ 98d4bf11-8f2a-4cdb-a2e7-8f807a663bb6
md"### p: Annual interest rate"

# ╔═╡ 58235d7b-39fe-402c-8c7e-2d787271f82c
md"## define ODE problem"

# ╔═╡ 09d08082-76aa-456b-b50f-72bea9e79048
md"## Solve problem"

# ╔═╡ 6cd159c5-6286-47a3-a490-96758e62d4f7
md"## plot solution"

# ╔═╡ b3377674-e60f-40f4-8fab-75c112f557a6
md"Beginning Balance: $(@bind u_begin Slider(0.0:100.0:50000.0, 0.0, true))"

# ╔═╡ f5a41768-97a4-4d3b-a7ce-e40691b69a1d
md"interest rate: $(@bind p Slider(0.01:0.01:1.0, 1.0, true))"

# ╔═╡ bfa8c882-3531-4b2d-8803-a25a0be344f9
md"Years: $(@bind t_end Slider(1.0:50.0, 1.0, true))"

# ╔═╡ 5bce5a73-9a6f-48d8-bb02-e1d6465ca52d
t_span = (0.0, t_end)

# ╔═╡ 3dd4d895-63cb-477e-8566-abbefdd5b60f
prob = ODEProblem(f, u_begin, t_span, p)

# ╔═╡ 38e6d441-4219-4ab1-be50-1d13827e4615
sol = solve(prob)

# ╔═╡ 7cb7e45d-e658-4b49-850e-5fe6e9583b64
md"Ending Balance: $(round(Int, sol(t_end)))"

# ╔═╡ fdb0024d-cfb7-452b-9d0b-8a5e6ea4aadf
plot(sol,
	legend = false,
	linewidth = 2.5,
...
# ╔═╡ 0f065897-572a-4ed2-943e-891766fd7637
Euler = ℯ

# ╔═╡ 974fee92-6e40-4250-89af-550a6dbdfdf7
Euler-sol[5]
