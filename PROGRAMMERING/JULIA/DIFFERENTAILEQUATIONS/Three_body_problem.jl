...
# ╔═╡ 9dd65f10-f190-11ed-0838-23f7c30ffa5c
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 102dc921-8b6e-4fea-a53b-a4cf35b9fce4
md"# Three-Body Problem"

# ╔═╡ 46ed57ab-13f6-4d2f-9c7e-46557ab1199b
md"$\begin{align}
...
\mathbf{{\ddot{r}}_3} &=
	...
	G m_2 \frac{{\mathbf{r_3}} - {\mathbf{r_2}}}
		{{|{\mathbf{r_3}} - {\mathbf{r_2}}|}^3} \\

\end{align}$"

# ╔═╡ d772b1d0-1222-485c-ad0b-ac868c6d1ad1
...
# ╔═╡ 060635ab-7347-4c73-b560-276d0f314636
@bind reset Button("Reset")

# ╔═╡ e664e101-a282-4390-872d-d1497e6ef2e3
t_begin = 0.0

# ╔═╡ d42daee2-eca1-44c3-9cf7-52f3f1b86e57
...
# ╔═╡ 066d37b7-25d8-494c-ba14-64c3342b70b5
md"## Plot Solution"

# ╔═╡ c3e801ae-9a0e-47d5-98ef-b89e5df29e61
begin
	reset
	@bind t_end Slider(0.0:0.001:100.0, 100.0, true)
end

# ╔═╡ 536648ca-4aa4-4da1-ae2b-bc55bffe6f10
tspan = (t_begin, t_end)

# ╔═╡ 345dcd8b-7228-46ab-867a-b08c55419af3
begin
	reset
	md"""
	Masses ||
...
# ╔═╡ 6e184988-2cd2-486a-af75-96111a0179ce
p = [m1, m2, m3]

# ╔═╡ ee7146db-d025-43d8-8da9-2e3f2fd78cfe
begin
	reset
	md"""
	Positions ||
...
# ╔═╡ d63c68f7-86c9-4435-a61a-9ea02829429f
begin
	reset
	md"""
	Velocities ||
...
# ╔═╡ 82a756de-fcf3-4767-8708-7ef6a8a8e3b0
u_0 = [
	x1_0, y1_0, x2_0, y2_0, x3_0, y3_0,
	vx1_0, vy1_0, vx2_0, vy2_0, vx3_0, vy3_0
]

# ╔═╡ 1135f7ca-7660-45be-8913-c55dc0ca1ccf
prob = ODEProblem(three_body, u_0, tspan, p)

# ╔═╡ 4aab4696-d112-42e4-9c83-024e9b093c17
sol = solve(prob, Vern7(), reltol = 1e-16, abstol = 1e-16)

# ╔═╡ cfe75b83-e19d-41e5-a1ea-cb800230d7f4
plot(sol)

# ╔═╡ c9b88b14-287b-4ff2-ae3a-055319ad9130
x_values, y_values = values(sol)

# ╔═╡ a2910d5d-5edf-4962-b5a9-41abfc245e67
x1_end = x_values[1][end]

# ╔═╡ 0f4fb757-925c-4edc-bcdc-4d310fad2bf6
y1_end = y_values[1][end]

# ╔═╡ 61decfd0-dc4e-4010-83ad-2575bdde18af
x2_end = x_values[2][end]

# ╔═╡ 9f460047-8c35-4b8a-92d1-1e1260b6aa0b
y2_end = y_values[2][end]

# ╔═╡ 78b45b7a-5c6a-4451-ac3c-0155277de063
x3_end = x_values[3][end]

# ╔═╡ 40817e12-171d-4970-918e-646496037b64
y3_end = y_values[3][end]

# ╔═╡ 86ab6ff9-672c-4586-9d87-ccbd5db34b75
plot(sol);

# ╔═╡ 9b8401b6-e2a6-4fc9-8993-a74836f4aaf6
plot(sol);

# ╔═╡ b756dcda-66e9-49b6-a800-f373ba6f889b
julia = Colors.JULIA_LOGO_COLORS

# ╔═╡ 6570ec6e-d7e5-4265-a460-64391cd1073d
...
# ╔═╡ 260faf78-018d-47ac-9f39-cfe681edd9cd
scatter!(traj,
