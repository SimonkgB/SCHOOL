...
# ╔═╡ 2b450a2e-57ed-42e1-a65c-51a8f8c28b1b
...
# ╔═╡ 7911d532-32f9-4667-afbe-cff76247339d
L = 1.0

# ╔═╡ 975f7606-b808-495a-8669-c4de8fa85d94
dx = 0.01

# ╔═╡ 1ef82805-954b-47e0-980d-326718444921
x = 0.0:dx:L

# ╔═╡ 8494f9fd-029c-47ef-8410-5f38f4c99f65


# ╔═╡ 88e99d98-7948-4ddc-957d-4985d8c9cbba


# ╔═╡ 43bc176b-a599-4451-b790-5e64ca2c302a
t_begin = 0.0

# ╔═╡ c46d760b-541e-4c4e-a0d7-4de594de935a


# ╔═╡ b8ab87ed-1c04-4ae6-9f89-05d44e6dba17
md"### controll panel"

# ╔═╡ d1c75d6e-a645-4483-b8ba-49e49955af3a

@bind reset Button("Reset")

# ╔═╡ a0f18d92-31d1-4a2d-927d-0fea62151e6a
begin
	reset
	md"Time: $(@bind t_end Slider(0.0:0.00001:0.01, 0.0, true))"
end

# ╔═╡ 49017c8c-6a46-4ee3-8d84-b1799204f9e9
tspan = (t_begin, t_end)

# ╔═╡ 2eae9525-898b-4377-ab4b-ae0d4ae76ee0
begin
	reset
	md"""
	Temprature ||
	Left: $(@bind left_temp Slider(0.0:0.01:1.9, 0.9, true)) |
	Right: $(@bind right_temp Slider(0.0:0.01:1.0, 0.1, true)) ||
	"""
end

# ╔═╡ 82bba78b-45f7-431d-bedc-1d59b9428b7e
u_begin = [i < L/2 ? left_temp : right_temp for i in x] 

# ╔═╡ c3f0b26b-40f7-4b1d-979e-90ce0b900da6
begin
	reset
	md"alpha:$(@bind alpha Slider(0.0:0.001:2.0, 0.5, true))"
end

# ╔═╡ 644bac7a-b000-498f-9549-8b4fd2dd3a6b
p = [alpha, dx]

# ╔═╡ b2d28f21-fdb9-4ca3-94a1-58e66568d4fd
prob = ODEProblem(heat_equation, u_begin, tspan, p)

# ╔═╡ bf981630-d3b6-49aa-a6b0-2252ffc3a2d2
sol = solve(prob)

# ╔═╡ a3c7fd6f-de25-4abb-946f-74bca48421f0
T = sol[end]

# ╔═╡ b124bc4a-2b66-4e28-a69f-5eff9e07a3b9
Tleft = T[1]

# ╔═╡ 081efee8-5b9e-47d7-81b3-a3234e701c92
T25 = T[25]

# ╔═╡ 34359a8b-cc93-4c7e-a9f5-b5ac39c76dbc
T51 = T[51]

# ╔═╡ 810b18c8-17f4-4232-89f0-f7d124f3371f
T76 = T[76]

# ╔═╡ 1b4f7ba1-13a6-43e0-a7b8-70e3f1f59af7
Tright = T[end]

# ╔═╡ 5cf3afdd-7257-4cb4-ab6d-0e25d95ac71a
plot((x, T),
	legend = false,
	linewidth = 3,
	title = "1-d Heat eq",
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "aa4bf6dcd3d0830356985d4d176e39178f67bfab"
